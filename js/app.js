...
(function () {
  ...
  function renderStats() {
    ...
    var porLote = [['Completas con fotos', estado.datos.totales.porLote.completas], ['Completas parte 2', estado.datos.totales.porLote.parte2], ['Plantillas del Excel', estado.datos.totales.porLote.plantillas], ['Pto. Montt / Varas', estado.datos.totales.porLote.v2]].map(function (x) { return { k: x[0], n: x[1] }; });
